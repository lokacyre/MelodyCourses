...
const contractABI = require("../artifacts/contracts/Melodycourses.sol/Melodycourses.json").abi;

program
    .name("melodycourses-cli")
    .description("CLI tool for Melodycourses smart contract")
    .version("1.0.0");
